...
export const metadata = {
    title: 'Платная госпитализация в Москву из регионов и СНГ — Медицинская Сервисная Компания. 8 (499) 719-81-00, 24/7',
    description: 'Организуем плановую и срочную госпитализацию в ведущие клиники Москвы для пациентов из регионов России и стран СНГ. Индивидуальный подбор лечебного учреждения, круглосуточная поддержка, комфортные условия размещения.',
